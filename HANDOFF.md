...
Current live version: **`v2.0.30`** (visible in bottom-right footer). `origin/main` is the source of truth; working tree is clean. **Session B (v2) is fully shipped** — AI plan generation end-to-end on Vercel + Claude Sonnet 4.6 is live at `www.sebvel.app`.
