...
Current live version: **`v2.2.1`** (visible in bottom-right footer). `origin/main` is the source of truth; working tree is clean. **Through v2.2.1 fully shipped** — AI plan generation, plan templates, AI exercise swap, enhanced View Recent, real-time Coach Chat, and structured per-session substitutions are live at `www.sebvel.app`.
