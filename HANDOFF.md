...
Current live version: **`v2.2.0`** (visible in bottom-right footer). `origin/main` is the source of truth; working tree is clean. **Through v2.2.0 fully shipped** — AI plan generation, plan templates, AI exercise swap, enhanced View Recent, and real-time Coach Chat are live at `www.sebvel.app`.
