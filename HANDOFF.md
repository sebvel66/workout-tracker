...
Current live version: **`v2.1.0`** (visible in bottom-right footer). `origin/main` is the source of truth; working tree is clean. **Session B (v2) + first v2.1 bundle are fully shipped** — AI plan generation, plan templates, AI exercise swap, and enhanced View Recent are live at `www.sebvel.app`.
